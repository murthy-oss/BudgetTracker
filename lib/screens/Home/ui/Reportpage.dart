     ...
     // dataMap={};
      for (var doc in event.docs) {
       ...
       int amount = int.tryParse(doc['Amount'].toString()) ?? 0;
        ...
        _colors.add(doc['Color'].toString()=='Blue'?Colors.blue:
        doc['Color'].toString()=='Red'?Colors.red:
        doc['Color'].toString()=='Yellow'?Colors.yellow:
        doc['Color'].toString()=='Orange'?Colors.orange:
        doc['Color'].toString()=='Green'?Colors.green:Colors.black);
                      ...
                      children: [
                        Container(
                          decoration: BoxDecoration(
                            ...
                            (expense.color=='Green')?Colors.green:
                            (expense.color=='Orange')?Colors.orange:null,
                          ),
                          height: 75.h,
                          width: 30.w,
