        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              buildTextFormField(
                  'categoryName', 'Enter category Name', categoryName_focus),
              ...
              GestureDetector(
                  onTap: () {
                    ...
                    getStarted_addData(categoryName, Amount,'$_selectedDate',SelectedColor);
                    Navigator.push(context,MaterialPageRoute(
                      builder: (context)=>LoadingScreen('AddElementToHome')));
